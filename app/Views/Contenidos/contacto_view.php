    ...
    <main>
        <section class="contenido">
            ...
            <section class="form-register">
                ...
                <?php echo form_input(['name' => 'correo', 'id' => 'correo', 'type' => 'email', 'class' => 'controls form_texto_corto', 'placeholder' => 'Ingrese su correo. Ej: nombre@gmail.com', 'value' => set_value('correo')]); ?>
                </div>
